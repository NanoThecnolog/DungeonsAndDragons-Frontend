...
interface SecondProps {
    ...
    handleRace: (value: RaceProps) => void
    handleSubRace: (value: SubRaceProps) => void
    elvySkills: string[]
}

export default function SegundaEtapa({ raceList, raceData, subRace, traits, specificTrait, subTrait, elvySkills, handleELvySkills, extraAbilitySet, handleRace, handleSubRace }: SecondProps) {
                ...
                {raceData ? (
                    <>
                        {raceData.map((race, index) => (
                            <div key={index} className={styles.cardRaceContainer}>
                                ...
                                <Accordion className={styles.cardItem}>
                                                        ...
                                                        {subRace && subRace.map((sub) =>
                                                            ...
                                                            sub.subRace.index === subrace.index && (
                                                                <>
                                                                    ...
                                                                    <AccordionActions>
                                                                        <Button type='button' onClick={(e) => handleSubRace(sub)}>Escolher sub-raça</Button>
                                                                    </AccordionActions>
                                                                </>
                                                            ))}
                                    ...
                                    <AccordionActions>
                                        <Button type='button' onClick={(e) => { setRace(race.raceData.index), handleRace(race) }}>Escolher raça</Button>
                                    </AccordionActions>
                                </Accordion>
                            </div>
                        ))}
